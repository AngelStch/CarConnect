...
export default function CreateOffer() {
  ...
  return (
    <section className="container-form">
      <header>Създайте оферта за автомобил</header>
      <form onSubmit={formik.handleSubmit} className="form-inputs">
        <div className="input-section">
          ...
          <input
            type="text"
            name="mealName"
            placeholder="Въведете име на колата"
        ...
        <div className="columns">
          <div className="input-section">
            <label>Брой налични автомобили:</label>
            <input
              type="number"
              name="quantity"
              placeholder="Колко налични бройки има от този автомобил"
              onChange={formik.handleChange}
        ...
        <div className="input-section">
          ...
          <input
            type="text"
            name="description"
            placeholder="Въведете описание за автомобила"
            onChange={formik.handleChange}
        ...
        <div className="input-section address-section">
          <label className="file">Снимка на колата:</label>
          <input
            type="text"
            id="myFile"
            placeholder="Въведете връзка към изображението на "
            name="offerImage"
            onChange={formik.handleChange}
