...
export default function index() {
  ...
  const handleRemove = async (item) => {
    ...
    if (data.success) {
      notifySuccess("Елементът е премахнат от количката.");
    }
    getAllCarts();
  };
  ...
  const handleAdd = async (item) => {
    ...
    if (data.success === true) {
      notifySuccess("Елементът е добавен в количката!");
    } else {
                        ...
                        >
                          <div className="card-body">
                            ...
                            <div className="d-flex justify-content-between">
                              ...
                              <p className="mb-2">{deliveryCharges}лв. (Безплатна)</p>
                            </div>
